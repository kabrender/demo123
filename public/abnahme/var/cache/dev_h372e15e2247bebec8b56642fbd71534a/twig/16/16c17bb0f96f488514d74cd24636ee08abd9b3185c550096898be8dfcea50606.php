...
class __TwigTemplate_39d7e9d6f89bb8c2ca0303877d03cffb532a1b7b3781068e979d2fde38bf7b12 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["page"] ?? null)]));
    ...
    public function block_layout_navigation_flyout_teaser_image($context, array $blocks = [])
    {
        ...
        echo "                            <a class=\"navigation-flyout-teaser-image-container\"
                               href=\"";
        // line 65
        echo twig_escape_filter($this->env, $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SeoUrlFunctionExtension']->seoUrl("frontend.navigation.page", ["navigationId" => twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "id", [], "any", false, false, false, 65)]), "html", null, true);
        echo "\"
                               title=\"";
        // line 66
        echo twig_escape_filter($this->env, ($context["name"] ?? null), "html", null, true);
        ...
        ((function () use ($context, $blocks) {
            ...
            return $this->loadTemplate($includeTemplate ?? null, "@Storefront/storefront/layout/navigation/flyout.html.twig", 67);
        })())->display(twig_array_merge($context, ["media" => twig_get_attribute($this->env, $this->source,         // line 68
($context["category"] ?? null), "media", [], "any", false, false, false, 68), "sizes" => ["default" => "310px"], "attributes" => ["class" => "navigation-flyout-teaser-image", "alt" => ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 74
($context["category"] ?? null), "media", [], "any", false, false, false, 74), "translated", [], "any", false, false, false, 74), "alt", [], "any", false, false, false, 74)) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "media", [], "any", false, false, false, 74), "translated", [], "any", false, false, false, 74), "alt", [], "any", false, false, false, 74)) : ("")), "title" => ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 75
($context["category"] ?? null), "media", [], "any", false, false, false, 75), "translated", [], "any", false, false, false, 75), "title", [], "any", false, false, false, 75)) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "media", [], "any", false, false, false, 75), "translated", [], "any", false, false, false, 75), "title", [], "any", false, false, false, 75)) : ("")), "data-object-fit" => "cover"], "name" => "navigation-flyout-teaser-image-thumbnails"]));
        // line 79
        echo "                            </a>
                        ";
    ...
    {
        return array (  469 => 79,  467 => 75,  466 => 74,  465 => 68,  458 => 67,  454 => 66,  450 => 65,  447 => 64,  437 => 63,  427 => 84,  422 => 81,  420 => 63,  416 => 61,  413 => 60,  403 => 59,  393 => 54,  391 => 52,  390 => 51,  389 => 50,  387 => 49,  377 => 48,  365 => 55,  363 => 48,  353 => 46,  343 => 45,  332 => 85,  330 => 59,  327 => 58,  325 => 45,  322 => 44,  312 => 43,  302 => 35,  293 => 34,  283 => 33,  273 => 36,  270 => 33,  260 => 32,  248 => 37,  246 => 32,  242 => 30,  232 => 29,  222 => 21,  214 => 17,  207 => 16,  197 => 15,  187 => 24,  183 => 22,  181 => 15,  177 => 14,  172 => 12,  169 => 11,  166 => 10,  156 => 9,  144 => 25,  142 => 9,  138 => 7,  128 => 6,  117 => 40,  115 => 29,  112 => 28,  110 => 6,  107 => 5,  97 => 4,  87 => 43,  84 => 42,  81 => 4,  78 => 3,  75 => 2,  56 => 1,);
    }

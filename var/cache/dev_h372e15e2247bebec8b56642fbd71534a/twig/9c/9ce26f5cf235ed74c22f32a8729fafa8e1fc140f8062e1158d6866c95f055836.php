...
";
    ...
    public function block_cms_breadcrumb($context, array $blocks = [])
    {
        ...
        // line 9
        echo "                    ";
        $this->loadTemplate("@Storefront/storefront/component/listing/breadcrumb.html.twig", "@Storefront/storefront/page/content/index.html.twig", 9)->display(twig_to_array(["context" =>         // line 10
($context["context"] ?? null), "navigationTree" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 11
($context["page"] ?? null), "header", [], "any", false, false, false, 11), "navigation", [], "any", false, false, false, 11), "tree", [], "any", false, false, false, 11), "category" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 12
($context["page"] ?? null), "header", [], "any", false, false, false, 12), "navigation", [], "any", false, false, false, 12), "active", [], "any", false, false, false, 12)]));
    ...
    {
        return array (  160 => 19,  157 => 18,  147 => 17,  137 => 14,  135 => 12,  134 => 11,  133 => 10,  131 => 9,  121 => 8,  110 => 20,  108 => 17,  104 => 15,  102 => 8,  99 => 7,  97 => 6,  87 => 5,  76 => 22,  74 => 5,  71 => 4,  61 => 3,  38 => 2,);
    }
